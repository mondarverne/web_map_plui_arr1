...
window.addEventListener('load', () => {
  Swal.fire({
    ...
    iconColor : '#f39200',
    text: "Dans le cadre de l'enquête publique, cette carte interactive présente le projet de Plan Local d'Urbanisme intercommunal (arrêté le 28/08/2025). \nCette version n'est pas définitive, un travail complémentaire sera engagé à la suite de l'enquête publique et des retours des personnes publiques associées (PPA).",
    icon: 'info',
...
var zonageLegend = new ol.legend.Legend({layer: data_vecteur_layer_exemple });
...
var presci_surfLegend = new ol.legend.Legend({layer: prescri_surf });
...
var presci_linLegend = new ol.legend.Legend({layer: prescri_lin });
...
var presci_ptLegend = new ol.legend.Legend({layer: prescri_pt });
